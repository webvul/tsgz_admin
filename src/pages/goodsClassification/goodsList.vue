<template>
    <div class="page goodsPage">
            ...
            <div class="content">
                <el-card class="box-card" style="margin: 15px 30px 15px 30px;">
                    <div class="text item">
                        <el-form :model="form" ref="form">
                            ...
                            <el-form-item label="排序" :label-width="formLabelWidth">
                                <el-slider v-model="form.sort" style="width:300px"></el-slider>
                            </el-form-item>
...
export default {
        ...
        methods: {
            ...
            deleteSelected(){
                let _this = this;
                AJAX.delete("website/gcc/gccContror/deleteMeun",{
                    id:this.form.id
                },function(){
                    _this.$message('操作成功');
